...
from lib.common.exceptions import anno sandboxPackageError
...
class Package(object):
    ...
    def get_path(self, application):
        ...
        raise anno sandboxPackageError("Unable to find any %s executable." %
                                 application)
        ...
        for rootkey, subkey, values in regkeys:
            ...
            for key, value in values.items():
                if isinstance(value, str):
                    ...
                    raise anno sandboxPackageError("Invalid value type: %r" % value)
    ...
    def execute(self, path, args, mode=None, maximize=False, env=None,
        ...
        if not p.execute(path=path, args=args, dll=dll, free=free,
            ...
            raise anno sandboxPackageError(
