...
from lib.common.exceptions import anno sandboxError, anno sandboxDisableModule
...
class ProcessList(object):
    ...
    def add_pid(self, pid, track=True):
        ...
        process, i.e., whether anno sandbox should wait for this process to finish.
        """
    ...
    def _inject_process(self, process_id, thread_id, mode):
        ...
        if process_id in (self.analyzer.pid, self.analyzer.ppid):
            if process_id not in self.ignore_list["pid"]:
                log.warning("Received request to inject anno sandbox processes, "
                            "skipping it.")
...
class Analyzer(object):
    ...
    def run(self):
        ...
        if not self.config.package:
            ...
            if not package:
                raise anno sandboxError("No valid package available for file "
        ...
        # If it fails, we need to abort the analysis.
            ...
            raise anno sandboxError("Unable to import package \"{0}\", does "
        ...
        try:
            ...
            raise anno sandboxError("Unable to select package class "
        ...
        for module in Auxiliary.__subclasses__():
            ...
            except anno sandboxDisableModule:
                continue
        ...
        # Hide the anno sandbox Analyzer & anno sandbox Agent.
...
if __name__ == "__main__":
    ...
    # anno sandboxError exception, which will force the termination of the analysis.
