...
from modules.processing.anno sandboxml import Instance

class VirusTotalResourceNotScanned(anno sandboxOperationalError):
...
class VirusTotalAPI(object):
    ...
    def _request_json(self, url, **kwargs):
        ...
        try:
            ...
            raise anno sandboxOperationalError("Unable to fetch VirusTotal "
                                         "results: %r" % e.message)
