...
from lib.anno sandbox.common.colors import bold, green, red, yellow
from lib.anno sandbox.common.objects import File
from lib.anno sandbox.common.utils import to_unicode
...
def main():
    ...
    parser.add_argument("--remote", type=str, action="store", default=None, help="Specify IP:port to a anno sandbox API server to submit remotely", required=False)
    ...
    # there will be a warning message, because anno sandbox can't resolve the
