...
if __name__ == "__main__":
    ...
    parser.add_argument("socket", nargs="?", default="/tmp/anno sandbox-rooter",
                        help="Unix socket path")
    parser.add_argument("-g", "--group", default="anno sandbox",
    ...
    log = logging.getLogger("anno sandbox-rooter")
    ...
    # Provide the correct file ownership and permission so anno sandbox can use it
    ...
    try:
        ...
        sys.exit(
            ...
            "through which anno sandbox will connect to the rooter, e.g., "
