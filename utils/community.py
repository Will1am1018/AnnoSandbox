...
import lib.anno sandbox.common.colors as colors
from lib.anno sandbox.common.constants import anno sandbox_ROOT

URL = "https://github.com/anno sandboxsandbox/community/archive/{0}.tar.gz"
...
def install(enabled, force, rewrite, archive):
    ...
    for category in enabled:
        ...
        installdir(origin, os.path.join(anno sandbox_ROOT, folder), force, rewrite)
...
def main():
    ...
    parser.add_argument("-s", "--signatures", help="Download anno sandbox signatures", action="store_true", required=False)
