...
from lib.core.host import anno sandboxHost

class Macalyzer(object):
    """anno sandbox OS X analyser.
    """
...
if __name__ == "__main__":
    ...
    try:
        ...
        anno sandbox = anno sandboxHost(config.ip, config.port)
        analyzer = Macalyzer(anno sandbox, config)
