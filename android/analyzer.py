...
from lib.common.exceptions import anno sandboxError, anno sandboxPackageError
...
class Analyzer(object):
    ...
    def run(self):
        ...
        if not self.config.package:
            ...
            if not package:
                raise anno sandboxError("No valid package available for file type: {0}".format(self.config.file_type))
        ...
        # If it fails, we need to abort the analysis.
            ...
            raise anno sandboxError("Unable to import package \"{0}\", does not exist.".format(package_name))
        ...
        try:
            ...
            raise anno sandboxError("Unable to select package class (package={0}): {1}".format(package_name, e))
        ...
        try:
            ...
            raise anno sandboxError("The package \"{0}\" doesn't contain a run "
                              "function.".format(package_name))
        except anno sandboxPackageError as e:
            raise anno sandboxError("The package \"{0}\" start function raised an "
                              "error: {1}".format(package_name, e))
        except Exception as e:
            raise anno sandboxError("The package \"{0}\" start function encountered "
